package org.iffat.local_class_challenge;

import org.iffat.local_class_challenge.domain.Employee;
    ...
    public static void printOrderedList(List<Employee> eList, String sortField) {
        ...
        class MyEmployee {
            ...
            public String toString() {
                return "%s has been an employee fo %d years".formatted(fullName, yearsWorked);
            }
        }
